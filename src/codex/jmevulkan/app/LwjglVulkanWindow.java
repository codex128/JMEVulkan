...
import codex.jmevulkan.lwjgl.LwjglSync;
 ...
 * @author codex
 */
public class LwjglVulkanWindow extends LwjglVulkanContext implements Runnable {
    ...
    public LwjglVulkanWindow(final JmeContext.Type type) {
    ...
    protected void createContext(final AppSettings settings) {
        ...
        //GLFW.glfwInitHint(GLFW.GLFW_CLIENT_API, GLFW.GLFW_NO_API);
...
//        }
    ...
    protected void runLoop() {
        ...
        if (renderable.get()) {
            try {
                ...
                if ((type != JmeContext.Type.Canvas) && allowSwapBuffers && autoFlush) {
    ...
    public MouseInput getMouseInput() {
        if (mouseInput == null) {
            mouseInput = new GlfwVulkanMouseInput(this);
        }
        return mouseInput;
    }
    ...
    public KeyInput getKeyInput() {
        if (keyInput == null) {
            keyInput = new GlfwVulkanKeyInput(this);
        }
        return keyInput;
    }
