...
import codex.jmevulkan.lwjgl.GlfwVulkanKeyInput;
import codex.jmevulkan.lwjgl.GlfwVulkanMouseInput;
import codex.jmevulkan.lwjgl.LwjglVulkanDebugOutputHandler;
 ...
 * @author codex
 */
public abstract class LwjglVulkanContext implements JmeContext {
    ...
    static {
        ...
        if (System.getProperty(implementation) == null) {
            if (Boolean.parseBoolean(System.getProperty(PROPERTY_CONCURRENT_BUFFER_ALLOCATOR, "true"))) {
                System.setProperty(implementation, LWJGLBufferAllocator.ConcurrentLWJGLBufferAllocator.class.getName());
            } else {
    ...
    protected GlfwVulkanKeyInput keyInput;
    protected GlfwVulkanMouseInput mouseInput;
    protected GlfwJoystickInput joyInput;

    protected Timer timer;

    protected NullOpenGLRenderer renderer;
    ...
    private void initContext(boolean first) {
        ...
        if (first) {
            ...
            this.renderer = new NullOpenGLRenderer(/*gl, glext, glfbo*/);
        ...
        /*if (capabilities.GL_ARB_debug_output && settings.isGraphicsDebug()) {
            ARBDebugOutput.glDebugMessageCallbackARB(new LwjglVulkanDebugOutputHandler(), 0);
        }*/
